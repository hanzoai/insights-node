// Type definitions for @hanzo/insights-node
// Project: Hanzo Insights

declare module '@hanzo/insights-node' {
    interface Option {
        flushAt?: number
    ...
    export default class Insights {
         ...
         * which you can later use in Hanzo Insights to find patterns in usage,
        ...
        /**
         * @description Identify lets you add metadata on your users so you can more easily identify who they are in Hanzo Insights,
         ...
         * The same concept applies for when a user logs in. If you're using Hanzo Insights in the front-end and back-end,
        ...
        /**
         * @description Hanzo Insights feature flags (https://insights.hanzo.ai/docs/features/feature-flags)
         * allow you to safely deploy and roll back new features. Once you've created a feature flag in Hanzo Insights,
         ...
         * IMPORTANT: To use this method, you need to specify `personalApiKey` in your config! More info: https://insights.hanzo.ai/docs/api/overview
        ...
        */
         ...
         * using my product in Hanzo Insights.
         *
