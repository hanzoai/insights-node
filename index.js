...
class Insights {
    /**
     * Initialize a new `Insights` with your Hanzo Insights project's `apiKey` and an
     ...
     *   @property {String} host (default: 'https://insights.hanzo.ai')
    ...
    constructor(apiKey, options) {
        ...
        assert(apiKey, "You must pass your Hanzo Insights project's api key.")

        this.queue = []
        this.apiKey = apiKey
        this.host = removeSlash(options.host || 'https://insights.hanzo.ai')
    ...
    enqueue(type, message, callback) {
        ...
        message.type = type
        message.library = '@hanzo/insights-node'
    ...
    flush(callback) {
        ...
        if (typeof window === 'undefined') {
            headers['user-agent'] = `@hanzo/insights-node/${version}`
        }
...
module.exports.default = Insights
module.exports.Insights = Insights
module.exports.PostHog = Insights
